...
if __name__ == "__main__":
    max_balls = 7
    #source_path = './dataset/jugglingLab/ss3_red_JugglingLab.mp4'
    source_path = './dataset/tanda2/ss7_red2_AlejandroAlonso.mp4'
    #source_path = './dataset/instagram/ss9_rohanjuggler.mp4'
