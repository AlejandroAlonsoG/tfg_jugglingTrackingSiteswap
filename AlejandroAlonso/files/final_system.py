...
from tracking.bg_substraction_tracking import get_division_point
...
def execute(evaluate = False, tracking_system = "", color_range = None, max_balls = None, tracking_preprocessing = False, max_cuadrant_misses = 20, ss_test_numbers = 5, ss=None, save_data = -1):
            ...
            if tracking_system == "ColorTrackingMaxBalls":
                ...
                ids = get_division_point(source_path, visualize=False, save_data=save_data)
            else:
            ...
            # Seq_extraction
            point = get_division_point(source_path, convergence_threshold=0, visualize=False)
